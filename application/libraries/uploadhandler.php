...
class Uploadhandler
{
    ...
    function __construct($params){//$options = null, $initialize = true, $error_messages = null) {
        $this->response = array();
        $this->options = array(
        ...
        if (array_key_exists('error_messages',$params) && $params['error_messages']) {
            $this->error_messages = $params['error_messages'] + $this->error_messages;
        }
        if (!array_key_exists('initialize',$params) || $params['initialize']) {
            $this->initialize();
        }
    }
